(function ($) {
    ...
    document.getElementById('consent').addEventListener("click", function () {
        if (document.getElementById('consent').checked) {
            ...
            document.getElementById('registerEmail').setAttribute("disabled", "")
        }
    });
